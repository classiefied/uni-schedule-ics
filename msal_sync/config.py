...
diff --git a/msal_sync/config.py b/msal_sync/config.py
new file mode 100644
index 0000000000000000000000000000000000000000..5e8a1b3d96ddfdb2b10d34105bf41b295f157a14
--- /dev/null
+++ b/msal_sync/config.py
@@ -0,0 +1,73 @@
